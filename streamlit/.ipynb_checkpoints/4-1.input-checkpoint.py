...
options = st.multiselect('좋아하는 색을 모두 선택하세요', ('Green', 'Blue', 'Red'))
...
title = st.text_input('최애 영화를 입력하세요', 'Sound of Musci') # 최초 입력 값
...
ymd = st.date_input('Whem is yout birthday', datetime(2000, 9, 6)) # 최초 입력 값
st.write('Youtre birthday is:', ymd)
