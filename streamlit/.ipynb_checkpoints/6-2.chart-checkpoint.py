...
x='date', y='sales', detail='teams', text=alt.Text('sales:Q') ) # 소수점 이하 1자리: 'sales:Q', format='.1f'
...
# 파일실행: File > New > Terminal(anaconda prompt) → python -m streamlit run streamlit\6-2.chart.py
